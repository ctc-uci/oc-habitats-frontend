...
const PredatorField = ({ predatorName, predatorId, isDisabled, predatorIndex }) => {
  ...
  return (
    <GridItem colSpan={1} rowSpan={1} width={{ md: '90%', sm: '80%' }}>
...
const PredatorsTab = ({ showHeader, isDisabled, predators }) => {
  ...
  return (
    <VStack spacing="23px" align="left">
      ...
      <SimpleGrid columns={{ md: 4, sm: 1 }} spacingX="64px" spacingY={{ md: '68px', sm: '30px' }}>
      ...
      <Spacer />
      <VStack spacing="8px" align="left">
        <HStack spacing={{ md: '380' }} justify={{ sm: 'space-between', md: 'start' }}>
          <Text fontWeight="500" fontSize="md">
            Other Predator(s)
          </Text>
          <Tooltip
