...
import SectionTableDescription from './SectionTableDescription';
import SectionTableHeader from './SectionTableHeader';
import SectionTableFooter from './SectionTableFooter';
import { SectionTableRow, NameColumn, SegmentColumn } from './SectionTableRow';
...
const SectionTable = ({ variant, userData, segments, loading }) => {
  ...
  return (
    <>
      ...
      <SectionTableDescription variant={variant} />
